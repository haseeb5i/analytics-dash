...
import type { TomSettings } from "tom-select/src/types/index.ts";
    ...
    <div>
      ...
      <${Select}
        ...
        tomSelectOpts=${{
          ...
          options: [
            { value: "1", text: "Regular Donation" },
            { value: "2", text: "Single Donation" },
          ],
        }}
      />
    </div>
    ...
    <div class="${cx.container}">
      <${Select}
        ...
        tomSelectOpts=${{
          ...
          searchField: ["name"],
          preload: true,
          load: function (_query: string, callback: any) {
            var url = "https://api.github.com/search/repositories?q=tomselect";
            fetch(url)
